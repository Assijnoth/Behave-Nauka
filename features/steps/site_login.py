...
# def enterUserdata(context, user, pwd):
#     context.driver.implicitly_wait(5)
#     context.driver.find_element_by_xpath("/html/body/div[1]/div/div/div[4]/div/div/div[2]/div[1]/div/input").clear()
#     context.driver.find_element_by_xpath("/html/body/div[1]/div/div/div[4]/div/div/div[2]/div[1]/div/input").send_keys(user)
#     context.driver.find_element_by_xpath("/html/body/div[1]/div/div/div[4]/div/div/div[2]/div[2]/div/input").clear()
#     context.driver.find_element_by_xpath("/html/body/div[1]/div/div/div[4]/div/div/div[2]/div[2]/div/input").send_keys(pwd)
